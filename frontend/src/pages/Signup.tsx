...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = signupSchema.safeParse({ fullname, username, email, password, university, branch, year });
    if (!result.success) {
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-8">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Join thousands of students sharing notes</p>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-card space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                <Input id="username" placeholder="Choose a username" className="pl-10" value={username} onChange={e => setUsername(e.target.value)} maxLength={50} required />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input placeholder="e.g. IIT Delhi" className="pl-10" value={university} onChange={e => setUniversity(e.target.value)} maxLength={200} />
              </div>
